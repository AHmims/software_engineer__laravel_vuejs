                ...
                if (!(!params.behavior.controls)) {
                    if (typeof (params.behavior.controls) == "object") {
                        if (params.behavior.controls.length > 0) {
                                    ...
                                    if (control.callback == "true") {
                                        ...
                                        btn.onclick = async function () {
                                            ...
                                            if (btnClickResult) {
                                                ...
                                                console.error('Callback function returned with  a value of => False');
                            ...
                            throw "The Controls attribute should be an array and have more than 1 entry";
                    } else
                        throw 'Type of the Controls attribute should be an object';
                } else
                    throw "The Controls attribute can't be empty or null";
